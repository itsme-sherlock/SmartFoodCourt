...
export const mockMenuItems = {
	vendor_1: [
		...
		},
		{
			...
			description: 'Chef special seasonal vegetables',
			basePrice: 170,
		...
		},
		{
			id: 'item_1_5',
			name: 'Kulfi Dessert',
			description: 'Creamy cardamom kulfi',
			basePrice: 90,
	...
	vendor_2: [
		...
		},
		{
			...
			description: 'Fresh coconut chutney with mustard tempering',
			basePrice: 40,
	...
	vendor_3: [
		...
		{
			id: 'item_3_2',
			name: 'Grill Platter (Limited)',
			description: 'Assorted grilled items - limited servings',
			basePrice: 520,
