    ...
    predictions: [
      {
        ...
        recommendation: 'Sunday trend shows steady demand. Stock up on popular items.',
      },
      {
        date: '2025-11-25',
        predictedOrders: 145,
        ...
        confidence: 88,
        factors: { dayOfWeek: 0.85, weatherImpact: 0.82, eventImpact: 0.90, historicalTrend: 0.87 },
        recommendation: 'Cultural Fest Day 1 - Increase staff and inventory by 30%. Prepare for high demand.',
      },
      {
        date: '2025-11-26',
        predictedOrders: 132,
        ...
        confidence: 90,
        factors: { dayOfWeek: 0.88, weatherImpact: 0.83, eventImpact: 0.0, historicalTrend: 0.86 },
        recommendation: 'Tuesday shows moderate-high growth. Prepare for extended lunch rush.',
      },
      {
        date: '2025-11-28',
        predictedOrders: 158,
        ...
        confidence: 85,
        factors: { dayOfWeek: 0.90, weatherImpact: 0.85, eventImpact: 0.88, historicalTrend: 0.87 },
        recommendation: 'Tech Summit Event - Increase inventory by 25%. Focus on quick-service items.',
      },
    ],
  };
